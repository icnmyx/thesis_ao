...
f = open(os.path.join(dir, f'eval_live_mult_2209_2_BENCH.log'),'w')
...
def live(param_file):
  ...
  return res, avg_deviance, var_deviance, abs_errs
  
  param_file = 'scao_sh_16x16_8pix.py'
  res, avg_deviance, var_deviance, abs_errs = live(param_file)
  ...
  file_name = "eval_live_mult_2209_2_BENCH.png"
